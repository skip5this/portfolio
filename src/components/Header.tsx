...
export function Header() {
  ...
  return <header className="sticky top-0 z-10 bg-white/80 backdrop-blur-sm border-b border-gray-100">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        {/* Mobile navigation */}
        {isMenuOpen && <nav className="absolute top-full left-0 right-0 bg-white border-b border-gray-100 py-4 md:hidden">
