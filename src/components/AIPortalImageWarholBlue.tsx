...
/**
 * Concept 4A-W-Blue: Landscape ASCII on Pale Blue
...
const PALETTE = [
  { h: 172, s: 68, l: 56 }, // turquoise
  { h: 255, s: 88, l: 66 }, // violet
  { h: 233, s: 100, l: 50 }, // electric blue
  { h: 48,  s: 83, l: 67 }, // pale yellow
  { h: 280, s: 60, l: 50 }, // purple
];

const BG_COLOR = '#dbeafe';
const DOT_BASE = { r: 30, g: 58, b: 138 };
const IMAGE_URL = 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=1200&h=600&fit=crop&q=80';

export function AIPortalImageWarholBlue() {
    ...
    for (let row = 0; row < rows; row++) {
      for (let col = 0; col < cols; col++) {
        ...
        if (dist < MOUSE_RADIUS_OUTER) {
          ...
          const { r, g, b } = DOT_BASE;
          ctx.fillStyle = `rgba(${r}, ${g}, ${b}, ${0.15 + (value - 0.5) * 0.7})`;
        } else {
          const { r, g, b } = DOT_BASE;
          ctx.fillStyle = `rgba(${r}, ${g}, ${b}, ${value * 0.3})`;
        }
